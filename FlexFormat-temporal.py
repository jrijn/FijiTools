...
def main():
    ...
    # Process channel 2. 
    # glidingprojection(imp, startframe=1,
    # stopframe=None, glidingFlag=True, no_frames_per_integral=3,
    ...
    # glidingprojection(channels[3], startframe=1, stopframe=None,
    # glidingFlag=True, no_frames_per_integral=3,
    # projectionmethod="Median") IJ.run(channels[3], "8-bit", "") 
